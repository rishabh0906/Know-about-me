    ...
    <>
      ...
      <div className="Main-Content slide-left">
        ...
        <p className="About-paragraph">
          ...
          <a
            href="https://www.codechef.com/users/rishabh_0906"
            target="_blank"
            rel="noreferrer"
          >
            codechef
          ...
          ,
          <a
            href="https://codeforces.com/profile/rishabhj945"
            target="_blank"
            rel="noreferrer"
          >
            codeforces
          ...
          ,
          <a
            href="https://leetcode.com/rishabh_0906/"
            target="_blank"
            rel="noreferrer"
          >
            leetcode
          ...
          Javascript .<br></br> I created many projects to enhance my skills and
          always looking for opportunity to switch from development to
          production mode.
          <br></br> <br></br>I hope you like this website!! {"\u{1f604}"}
        </p>
      </div>
    </>
  );
